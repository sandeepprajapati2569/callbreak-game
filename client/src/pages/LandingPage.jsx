        ...
        <div className="rounded-2xl border border-[rgba(212,175,55,0.35)] bg-[rgba(212,175,55,0.1)] p-4">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <button
              ...
              className="px-3 py-2 rounded-lg text-sm font-semibold text-black shrink-0"
    ...
    <div className="space-y-4">
      <div className="grid gap-3 xl:grid-cols-2">
        <div className="rounded-2xl border border-white/10 bg-black/25 p-4">
          ...
          <h3 className="text-lg font-semibold mt-2">Pick a username your friends can search</h3>
          <p className="text-sm opacity-65 mt-1">
            A short username is easier for players to remember than email or room codes.
          </p>
          ...
          <div className="flex gap-2 mt-4">
            ...
            <button
              ...
              className="px-3 py-2.5 rounded-xl text-black disabled:opacity-50 flex items-center gap-1.5"
              style={{ background: 'linear-gradient(135deg, var(--gold), var(--gold-light))' }}
            >
              <AtSign size={15} />
              Claim
          ...
          <p className="text-xs opacity-50 mt-3">
            Current username: {activeUsername ? `@${activeUsername}` : 'not claimed yet'}
          </p>
        </div>

        <div className="rounded-2xl border border-white/10 bg-black/25 p-4">
          <p className="text-xs uppercase tracking-[0.24em] opacity-45">Add Friends</p>
          <h3 className="text-lg font-semibold mt-2">Search once, then invite in one tap</h3>
          <p className="text-sm opacity-65 mt-1">
            Search by username first. Email, exact display name, and UID still work as fallback.
          </p>
      ...
      <div className="rounded-2xl border border-white/10 bg-black/25 p-4">
        <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <h3 className="text-lg font-semibold mt-2">Your people, ready to invite</h3>
          </div>
          <div className="flex flex-wrap gap-2">
              ...
              >
                ...
                <div className="flex flex-wrap items-center gap-2">
                  <button
                    ...
                    className="px-3 py-2 rounded-lg text-xs font-semibold flex items-center gap-1.5 disabled:opacity-45"
                    style={
                  ...
                  <button
                    ...
                    className="p-2 rounded-lg text-xs disabled:opacity-45"
      ...
      {blockedUsers.length > 0 && (
        <div className="rounded-2xl border border-red-400/15 bg-red-500/5 p-4 space-y-2">
          ...
          {blockedUsers.map((blockedUser) => (
            <div key={blockedUser.uid} className="flex items-center justify-between gap-3 rounded-xl border border-red-400/12 bg-black/15 px-3 py-2.5">
              <div className="min-w-0">
              ...
              <button
                ...
                className="px-3 py-1.5 rounded-lg text-xs bg-white/10 hover:bg-white/15 disabled:opacity-50"
              >
                Unblock
              </button>
            </div>
          ...
          {outgoingFriendRequests.map((request) => (
            <div key={request.id} className="flex flex-col gap-3 rounded-xl border border-white/10 bg-black/20 px-3 py-3 sm:flex-row sm:items-center sm:justify-between">
              ...
              <button
                ...
                className="px-3 py-2 rounded-lg text-sm font-semibold bg-white/10 hover:bg-white/15 disabled:opacity-50"
              >
                Cancel
              </button>
            </div>
      ...
      >
        <div className="space-y-6">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <motion.p
              className="text-sm sm:text-base opacity-55 max-w-2xl mx-auto mt-3 leading-6"
              initial={{ opacity: 0 }}
              animate={{ opacity: 0.55 }}
              transition={{ delay: 0.55, duration: 0.6 }}
            >
              Play is on the left. Friends, party, and invites live on the right. The screen now follows the same order users think in:
              choose a mode, start a table, then bring people in.
            </motion.p>
          ...
          <div className="grid gap-6 xl:grid-cols-[minmax(0,430px)_minmax(0,1fr)] items-start">
            <motion.div
              className="space-y-4"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <div className="rounded-[28px] border border-white/10 bg-[rgba(3,12,8,0.58)] p-4 sm:p-5 backdrop-blur-sm shadow-[0_18px_60px_rgba(0,0,0,0.28)]">
                <div className="flex items-start justify-between gap-3">
                  <div>
                    <p className="text-xs uppercase tracking-[0.24em] opacity-45">Account</p>
                    <h2 className="text-xl font-semibold mt-2">Start here</h2>
                    <p className="text-sm opacity-60 mt-1">
                      Sign in once, then choose how you want to play.
                    </p>
                  </div>
                  {user && (
                    <div className="px-3 py-1.5 rounded-full text-[11px] uppercase tracking-[0.22em] bg-white/8 text-white/60">
                  ...
                  {authLoading ? (
                    ...
                    <div className="space-y-3">
                      <motion.button
                        ...
                        disabled={signingIn}
                        className="w-full flex items-center justify-center gap-3 px-5 py-3.5 rounded-xl font-semibold text-base transition-all duration-300 disabled:opacity-50"
                        style={{
                      ...
                      <AnimatePresence>
                        {showGuestInput ? (
                          ...
                          <motion.button
                            ...
                            className="w-full py-3 rounded-xl font-semibold text-sm tracking-wide border border-white/20 text-white/70 hover:text-white hover:border-white/40 transition-all duration-300"
                    ...
                    <div className="rounded-2xl border border-white/10 bg-white/5 px-4 py-4">
                      ...
                      <div className="grid gap-2 mt-4 sm:grid-cols-3">
                        <div className="rounded-xl bg-black/20 px-3 py-3 border border-white/8">
                          <p className="text-[10px] uppercase tracking-[0.22em] opacity-45">Mode</p>
                          <p className="text-sm font-semibold mt-1">{gameMode === 'donkey' ? 'Gadha Ladan' : 'Call Break'}</p>
                        </div>
                        <div className="rounded-xl bg-black/20 px-3 py-3 border border-white/8">
                          <p className="text-[10px] uppercase tracking-[0.22em] opacity-45">Table</p>
                          <p className="text-sm font-semibold mt-1">{maxPlayers} players</p>
                        </div>
                        <div className="rounded-xl bg-black/20 px-3 py-3 border border-white/8">
                          <p className="text-[10px] uppercase tracking-[0.22em] opacity-45">Social</p>
                          <p className="text-sm font-semibold mt-1">{socialEnabled ? 'Ready' : 'Limited'}</p>
                        </div>
                      </div>
                    </div>
                  )}
              ...
              <div className="rounded-[28px] border border-white/10 bg-[rgba(3,12,8,0.58)] p-4 sm:p-5 backdrop-blur-sm shadow-[0_18px_60px_rgba(0,0,0,0.28)]">
                <p className="text-xs uppercase tracking-[0.24em] opacity-45">Game Setup</p>
                <h2 className="text-xl font-semibold mt-2">Choose your table</h2>
                <p className="text-sm opacity-60 mt-1">
                  First pick the game mode and table size. These settings carry into quick play, private rooms, and party creation.
                </p>

                <motion.div
                  className="flex rounded-2xl overflow-hidden border border-white/10 mt-4"
                ...
                <div className="mt-5">
                  <p className="text-sm opacity-55 mb-3">Players at the table</p>
              ...
              <div className="rounded-[28px] border border-white/10 bg-[rgba(3,12,8,0.58)] p-4 sm:p-5 backdrop-blur-sm shadow-[0_18px_60px_rgba(0,0,0,0.28)]">
                ...
                <h2 className="text-xl font-semibold mt-2">Choose how to enter a match</h2>
                <p className="text-sm opacity-60 mt-1">
                  Quick Play is the fastest path. Private rooms and join-by-code stay separate so users understand what each action does.
                </p>
                ...
                {user ? (
                  <div className="space-y-4 mt-4">
                    <motion.button
                      ...
                      className="w-full flex items-center justify-center gap-2 px-5 py-4 rounded-2xl font-semibold text-black text-base transition-all duration-300 disabled:opacity-50"
                      style={{
                  ...
                  <div className="mt-4 rounded-2xl border border-dashed border-white/12 bg-white/5 px-4 py-5">
                    <p className="text-sm font-medium">Sign in first to unlock play options</p>
                    <p className="text-xs opacity-55 mt-1 leading-5">
                      Once you sign in, this panel becomes your start area for quick play, private rooms, and join-by-code.
                    </p>
                  </div>
                )}
              </div>
              ...
              <div className="rounded-[28px] border border-white/10 bg-[rgba(3,12,8,0.58)] p-4 sm:p-5 backdrop-blur-sm shadow-[0_18px_60px_rgba(0,0,0,0.28)]">
                <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                  <div>
                    ...
                    <h2 className="text-xl font-semibold mt-2">People and party management</h2>
                    <p className="text-sm opacity-60 mt-1">
                      Keep invites, friend search, and party setup in a separate workspace so the home screen is easier to understand.
                    </p>
                  </div>
